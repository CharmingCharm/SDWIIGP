...
PRIVATE_ENV = os.path.join(BASE_DIR, 'private.env')
...
class DevelopmentConfig(Config):
	SQLALCHEMY_DATABASE_URI = os.environ.get('SQLALCHEMY_DATABASE_URI_DEVELOP') or 'mysql+pymysql://root@localhost/oj'

# 生产环境
class ProductionConfig(Config):
	SQLALCHEMY_DATABASE_URI = os.environ.get('SQLALCHEMY_DATABASE_URI_PRODUCTION') or 'mysql+pymysql://root@localhost/oj'
